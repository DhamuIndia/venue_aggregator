...
| P2 | `POST /uploads/presign` | `TODO` | `/vendor?tab=portfolio`, `/owner?tab=media` | `TODO` | Shared MinIO/S3 upload signing; use `VENDOR_PORTFOLIO` and `OWNER_HALL_MEDIA` purpose |

...
public class VendorLeadController {
    ...
    @GetMapping("/admin/vendor-leads")
    public List<VendorLeadResponse> getAdminVendorLeads(Authentication authentication) {
        return vendorLeadService.getAdminLeads(authentication);
    }
